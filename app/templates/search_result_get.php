...
<div class="container container-custom mt-4 mb-3">
    ...
    <div class="activity-recommendation p-4 rounded">
        ...
        <div class="mt-4"> <span class="text-muted"></span></div>
    </div>
    <div class="mt-2">
    </div>
</div>
    ...
    <style>
        ...
        .activity-recommendation { background-color:rgb(255, 255, 255); border-radius: 0.5rem; padding: 20px; position: relative; height: 0px; }
